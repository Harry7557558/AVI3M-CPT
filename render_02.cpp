...
int main() {
	...
	for (int Frame = 0; Frame < 2; Frame++) {
		...
		if (Frame == 0) CamP = vec3(224.870899, 147.306350, 97.507594), ScrO = vec3(190.993716, 99.119279, 76.173271), ScrA = vec3(-19.859960, 24.062876, 0.000000), ScrB = vec3(-2.901968, -2.395099, 17.653458);
		if (Frame == 1) CamP = vec3(136.245553, 140.407405, 95.299930), ScrO = vec3(179.641730, 126.351513, 75.069600), ScrA = vec3(-21.612397, -27.755883, 0.000000), ScrB = vec3(3.504220, -2.728596, 19.860799);
		...
		// output
		stbi_write_png(&(std::string("render_02_") + char('0' + Frame) + ".png")[0], W, H, 4, &IMG[0][0], 4 * W);
